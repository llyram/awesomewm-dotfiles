...
local WIDGET_DIR = HOME .. '/.config/awesome/ui/bar/battery-widget'
...
local function worker(user_args)
    ...
    local path_to_icons = gears.filesystem.get_configuration_dir() .. "ui/bar/battery-widget/"
    ...
    local display_notification_onClick =
        args.display_notification_onClick or true
    ...
    -- To use theme.colors from beautiful theme put
    ...
    local function show_charged_battery_warning()
        naughty.notify {
            icon = warning_msg_icon,
            icon_size = 100,
            text = 'The battery has reached 90% charge',
