...
local dir = gears.filesystem.get_configuration_dir() .. "ui/exit-screen/"
local lock = dir .. "lock.svg"
local logout = dir .. "logout.svg"
local power = dir .. "power.svg"
local sleep = dir .. "power-sleep.svg"
local restart = dir .. "restart.svg"
...
local poweroff = buildButton(power, 'Shutdown')
...
local reboot = buildButton(restart, 'Restart')
...
local suspend = buildButton(sleep, 'Sleep')
...
local exit = buildButton(logout, 'Logout')
exit:connect_signal(
  'button::release',
  function()
    exit_command()
...
local lock = buildButton(lock, 'Lock')
lock:connect_signal(
  'button::release',
  function()
    lock_command()
