...
awful.keyboard.append_global_keybindings(
    {
        ...
        awful.key({superkey}, "o",
                  function() _G.screen.primary.right_panel:toggle() end, {
        ...
        awful.key({superkey}, "f", function() awful.spawn.with_shell("nautilus") end,
        ...
        awful.key({superkey}, "c",
                ...
                end, {description = "open csTimer", group = "launcher"})
    })
